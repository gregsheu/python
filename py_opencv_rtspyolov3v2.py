...
fps = int(vcap.get(5))
out = cv2.VideoWriter('py_opencv_yolov3v2.mp4', cv2.VideoWriter_fourcc('m', 'p', '4', 'v'), fps, (width, height))
...
while vcap.isOpened():
    ...
    if not ret:
        ...
        break
    #cv2.VideoWriter("appsrc ! videoconvert ! videoscale ! video/x-raw,width=704,height=480 ! x264enc ! mpegtsmux ! hlssink playlist-root=rtmp://192.168.1.206/live/cam1 location=/var/task/mysite/mysite/static/hls/cam1-%05d.ts playlist-location=/var/task/mysite/mysite/static/hls/cam1.m3u8",
    #0,
    #20,
    #(704, 480),
    #True)
