...
def gmail(gmail_service, webviewlink):
    ...
    message = "Our car plate recoginition system (Trailer %(id)s IP %(ip)s) detects car plate at https://www.google.com/maps?q=%(lat)s,%(lon)s . Please log on here to view the snapshots %(link)s" % trailer_infos
