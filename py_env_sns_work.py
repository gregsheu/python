        ...
        if line:
            ...
            if 'Appear' in decoded_line:
                ...
                for i in range(1, 3):
                    ...
                    s3_c.upload_file('tripsnap-%s-%s.jpg' % (i, newtime), 'ksdevbatchwest2', 'tripsnap-%s-%s.jpg' % (i, newtime))
                    tripsnapshot = 'tripsnap-%s-%s.jpg' % (i, newtime)
                    s3_c.put_object_acl(Bucket='ksdevbatchwest2', Key=tripsnapshot, ACL='public-read')
                    ...
                    s3_c.upload_file('tripvideo-%s-%s.mp4' % (i, newtime), 'ksdevbatchwest2', 'tripvideo-%s-%s.mp4' % (i, newtime))
                    s3_c.put_object_acl(Bucket='ksdevbatchwest2', Key=tripvideo, ACL='public-read')
                    s3_url = 'https://ksdevbatchwest2.s3-us-west-2.amazonaws.com/'
