...
def main():
    ...
    #    process.join()
        ...
        t = i['id'] + '1'
        print(t)
        t = multiprocessing.Process(target=run_ffmpeg, args=(ip, 1, server, 1,))
        t.start()
        t = i['id'] + '2'
        t = multiprocessing.Process(target=run_ffmpeg, args=(ip, 2, server, 2,))
        t.start()
        t = i['id'] + '3'
        t = multiprocessing.Process(target=run_ffmpeg, args=(ip, 3, server, 3,))
        t.start()
        t = i['id'] + '4'
        t = multiprocessing.Process(target=run_ffmpeg, args=(ip, 4, server, 4,))
        t.start()
